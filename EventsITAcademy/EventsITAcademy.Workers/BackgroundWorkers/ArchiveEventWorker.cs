...
{
    public class ArchiveEventWorker : BackgroundService
    {
        ...
        private string Schedule => "*/59 */2 * * * *";

        public ArchiveEventWorker(ILogger<TicketWorker> logger, IServiceProvider serviceProvider)
        {
            _logger = logger;
