...
namespace EventsITAcademy.MVC.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(LoginUserRequestModel userRequest,string returnUrl = null)
        {
            returnUrl ??= Url.Content("~/");
            ...
            try
            {
                var user = await _userService.AuthenticateAsync(new CancellationToken(), userRequest);
                if(user != null)
                {
